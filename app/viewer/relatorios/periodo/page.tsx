...
import { Calendar, FileSpreadsheet, FileText, Download, ArrowLeft, AlertCircle } from 'lucide-react';
...
export default function ViewerRelatorioPeriodoPage() {
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-amber-700 dark:text-amber-300 mt-1">
                      Solicite ao administrador que configure os períodos da instituição.
                    </p>
                  </div>
                </div>
              </div>
