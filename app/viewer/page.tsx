...
export default function ViewerDashboardPage() {
  ...
  const loadDashboardData = async (institutionId: string) => {
    try {
      ...
      const [studentsRes, classesRes, teachersRes, monthRes, graveRes, recentRes] = await Promise.all([
        supabase
          .from('students')
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <QuickActionCard
              title="Ver Analytics"
              description="Graficos e analises detalhadas"
              icon={BarChart3}
