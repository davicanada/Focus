...
# Report and Email Accent Corrections Plan

> Correct Portuguese accents in report generation files (periodo/page.tsx) and verify email templates.
...
- **Total symbols discovered:** 258
- **Architecture layers:** Utils, Controllers, Components, Models
- **Entry points:** types\index.ts, lib\supabase\server.ts, lib\ai\index.ts

### Key Components

**Key Interfaces:**
- `Institution` — C:\Users\davia\OneDrive\Área de Trabalho\Hashtag Data Analyst\Projetos\Focus\types\index.ts:13
- `User` — C:\Users\davia\OneDrive\Área de Trabalho\Hashtag Data Analyst\Projetos\Focus\types\index.ts:34
- `UserInstitution` — C:\Users\davia\OneDrive\Área de Trabalho\Hashtag Data Analyst\Projetos\Focus\types\index.ts:47
- `Class` — C:\Users\davia\OneDrive\Área de Trabalho\Hashtag Data Analyst\Projetos\Focus\types\index.ts:58
- `Student` — C:\Users\davia\OneDrive\Área de Trabalho\Hashtag Data Analyst\Projetos\Focus\types\index.ts:76
## Agent Lineup
